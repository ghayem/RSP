...
function [J_N] = CostFunction_classic(params, x_K, x_N)
...
%     x_K_new = sort ([x_K ; x_Ni]);     % selected
    ...
    C_NK1 = Cov ( rho_a, sig_a, x_N_new, x_K_new );
    
    C_NN1 = Cov ( rho_a, sig_a, x_N_new, x_N_new ) ;
    
    C_KK1 = Cov ( rho_a, sig_a, x_K_new, x_K_new ) + Cov ( rho_n, sig_n, x_K_new, x_K_new );
