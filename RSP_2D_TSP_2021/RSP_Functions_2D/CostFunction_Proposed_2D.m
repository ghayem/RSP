...
function [J_N] = CostFunction_Proposed_2D(params, a_K, m_K, x_K, x_N, m_N )
...
G_NK = My_2D_Cov ( rho_n, sig_n, x_Ni, x_K );


C_NN = My_2D_Cov ( rho_a, sig_a, x_Ni, x_Ni ) ;
G_NN = My_2D_Cov ( rho_n, sig_n, x_Ni, x_Ni ) ;
